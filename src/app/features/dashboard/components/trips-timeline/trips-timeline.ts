...
@Component({
  ...
  styles: [
    `
      /* Timeline alineado a la izquierda - SIN romper la línea */
      ::ng-deep .p-timeline.p-timeline-vertical .p-timeline-event-opposite {
        flex: 0 !important;
        width: 0 !important;
        padding: 0 !important;
      }

      ::ng-deep .p-timeline.p-timeline-vertical .p-timeline-event-content {
        flex: 1 !important;
        padding-left: 2rem !important;
        padding-right: 0 !important;
      }

      ::ng-deep .p-timeline.p-timeline-vertical .p-timeline-event-separator {
        flex-direction: column !important;
      }

      ::ng-deep .p-timeline.p-timeline-vertical .p-timeline-event-connector {
