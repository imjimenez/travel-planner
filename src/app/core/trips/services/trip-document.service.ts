...
import type { TripDocument, UploadDocumentData } from '../models/trip-document.model';
...
export class TripDocumentService {
  ...
  async deleteDocument(documentId: string): Promise<void> {
    ...
    if (storageError) {
      ...
      // Continuar eliminando de BD aunque falle el storage
    }
    ...
    if (dbError) throw new Error(`Error al eliminar documento: ${dbError.message}`);
  }
