...
export class LeafletService {
  ...
  private createPopupContent(marker: MapMarker): string {
    ...
    if (marker.description) {
      content += marker.title ? `<br>${marker.description}` : marker.description;
    }
    return content;
  }
   ...
   */
  private orderPointsByProximity(coordinates: MapCoordinates[]): MapCoordinates[] {
   ...
   */
  onMapClick(map: L.Map, callback: (coordinates: MapCoordinates) => void): void {
